        ...
        <ScrollView
          ...
          <View style={styles.headerSection}>
            ...
            <View style={styles.walletArea}>
              <Text style={styles.walletAmount}>
                {' '}
                {Theme.currency}{' '}
                {state && state.wallet && state.wallet.wallet
                  ? state.wallet.wallet.toFixed(2)
                  : 0.0}
              </Text>
            </View>
          </View>
            ...
            <View style={styles.transactionSection}>
              <View style={[styles.item, {flexDirection: 'row'}]}>
                ...
                <View>
                  ...
                  <Text style={styles.transactionText2}>
                    ...
                    state.income.length &&
                    state.income[0] &&
                    state.income[0].amount
                      ? state.income[0].amount.toFixed(2)
                      : 0.0}
                  </Text>
                </View>
              </View>
              <View style={[styles.item, {flexDirection: 'row'}]}>
                ...
                <View>
                  ...
                  <Text style={styles.outcomeValue}>
                    ...
                    state.outcome[0] &&
                    state.outcome[0].amount
                      ? state.outcome[0].amount.toFixed(2)
                      : 0.0}
                  </Text>
                </View>
              </View>
              <View style={[styles.item, {flexDirection: 'row'}]}>
                <TouchableOpacity
                  ...
                  <View>
                    <Text style={styles.transactionAreaText}>
                      Transaction
                      {'   '}
          ...
          <View style={styles.footer}>
            <View style={styles.footerCard}>
              ...
              <View style={styles.item}>
                <TouchableOpacity
                  onPress={() => props.navigation.navigate('VendorListScreen')}>
                  <ImageBackground
                    source={Icon.payment}
                    style={styles.imageIcon}
                  />
              ...
              <View style={styles.item}>
                <TouchableOpacity
                  onPress={() =>
                    props.navigation.navigate('PaymentRequestScreen')
                  }>
                  <ImageBackground
                    source={Icon.betting}
                    style={styles.imageIcon}
