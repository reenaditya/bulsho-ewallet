...
export default function Login({navigation}) {
  const [email, setEmail] = useState('adityakumar1.ak127@gmail.com');
  ...
  const clearAndDismissKeyboard = () => {
    Keyboard.dismiss();
    setEmail('adityakumar1.ak127@gmail.com');
    setPassword('123456');
    setErrorEmail('');
    setErrorPassword('');
  };
  ...
  const handleSubmitPress = async () => {
    ...
    if (email && password) {
      ...
      email
        ? setErrorEmail('')
        : setErrorEmail('Email / Mobile Number field is required');
      password
        ? setErrorPassword('')
      ...
      <SafeAreaView>
        <ScrollView>
          <View style={{alignItems: 'center'}}>
            ...
            <View
              style={[styles.inputView, errEmail ? {marginBottom: 60} : {}]}>
              <Input
                label="Your Account"
                ...
                leftIcon={
                  <Icon name="user" size={16} color={Theme.iconColor} />
                }
              />
            </View>
            <View style={styles.inputView}>
              <Input
                ...
                leftIcon={
                  <Icon name="lock" size={16} color={Theme.iconColor} />
                }
                rightIcon={
                  <Icon
                    name={state.icon}
